...
import {setClearGenreManga, setClearTypeManga} from "../../store/slices/mangaSlice";
...
function MainPage() {
    ...
    const handleClearType=() => dispatch(setClearTypeManga())
    const handleClearGenre=() => dispatch(setClearGenreManga())
        ...
        <main className={`container ${classes.main}`}>
            <aside className={classes.main__aside}>
                ...
                <div className={classes.main__aside_type}>
                    <MuiCheckbox muiCheckbox={typeManga} manga="type"/>
                </div>
